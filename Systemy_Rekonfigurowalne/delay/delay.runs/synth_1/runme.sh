...
HD_PWD='C:/Studia/Semestr 6/Systemy Rekonfigurowalne/delay/delay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay.tcl
