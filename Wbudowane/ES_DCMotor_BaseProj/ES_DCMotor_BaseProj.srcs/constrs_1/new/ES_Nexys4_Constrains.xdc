## Plik konfiguracyjny .xdc dla plytki Nexys4 DDR firmy Digilent
## Do uzytku w projekcie sterownika silnika DC realizowanym na zajeciach z ES:
## - parametry sygnalu zegarowego musza byc zawsze odblokowane
## - wykorzystane w projekcie wejscia/wyjscia nalezy odblokowac. Domyslnie odblokowano 4 pierwsze przelaczniki hebelkowe i pierwsze 4 diody LED

## Ustalenie parametrow sygnalu zegarowego CLK
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK100MHz }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {CLK100MHz}];

set_property CFGBVS VCCO [current_design]
#where value1 is either VCCO (3.3V or 2.5V) or GND (1.8V or 1.5V
set_property CONFIG_VOLTAGE 3.3 [current_design]
#where value2 is the voltage provided to configuration bank 0


## Przelaczniki: Switch[0] - Switch[15]
...
## Zlacza sygnalowe Pmod (Headers)

##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { Enc2_A }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { Enc2_B }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { Therm }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { Brake }]; #IO_L18N_T2_A23_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { Enc1_A }]; #IO_L16N_T2_A27_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { Enc1_B }]; #IO_L16P_T2_A28_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { PWM }]; #IO_L22N_T3_A16_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { Dir }]; #IO_L22P_T3_A17_15 Sch=ja[10]
