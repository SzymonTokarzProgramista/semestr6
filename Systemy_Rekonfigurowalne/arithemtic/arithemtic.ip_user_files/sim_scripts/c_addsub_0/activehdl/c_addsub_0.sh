...
#
# Script generated by Vivado on Mon Apr 08 22:30:23 +0200 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Studia/Semestr_6/Systemy_Rekonfigurowalne/arithemtic/arithemtic.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
