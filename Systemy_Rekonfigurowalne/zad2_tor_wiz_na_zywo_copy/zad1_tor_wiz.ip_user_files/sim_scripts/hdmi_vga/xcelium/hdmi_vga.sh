...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../zad1_tor_wiz.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       +incdir+"../../../../zad1_tor_wiz.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" \
       +incdir+"../../../../zad1_tor_wiz.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
       +incdir+"../../../../zad1_tor_wiz.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       -input simulate.do
}
