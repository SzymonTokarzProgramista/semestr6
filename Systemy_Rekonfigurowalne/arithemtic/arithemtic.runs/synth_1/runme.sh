...
HD_PWD='C:/Studia/Semestr_6/Systemy_Rekonfigurowalne/arithemtic/arithemtic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dzialanie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dzialanie.tcl
