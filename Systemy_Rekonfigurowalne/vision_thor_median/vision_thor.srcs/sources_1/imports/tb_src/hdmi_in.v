...
//    rgbfile = $fopen("/home/lsriw/SR/StyczenJakub/hdmi_vga_zybo_src/geirangerfjord_64.ppm","rb");
    rgbfile = $fopen("C:/Studia/Semestr_6/Systemy_Rekonfigurowalne/model_rgb_ycrcb/reka_zmniejszona","rb");
	 // read header file
	 for(i=0;i<13;i=i+1)
    begin
      v=$fgetc(rgbfile); 
