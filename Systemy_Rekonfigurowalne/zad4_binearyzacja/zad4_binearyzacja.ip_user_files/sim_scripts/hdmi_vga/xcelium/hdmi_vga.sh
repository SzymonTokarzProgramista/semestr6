...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../zad4_binearyzacja.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       +incdir+"../../../../zad4_binearyzacja.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       +incdir+"../../../../zad4_binearyzacja.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
       +incdir+"../../../../zad4_binearyzacja.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" \
       -input simulate.do
}
