...
#
# Generated by Vivado on Tue Apr 09 10:11:43 +0200 2024
...
simulate()
{
  xsim  dist_mem_gen_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_vga.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Programy/Vivado/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
